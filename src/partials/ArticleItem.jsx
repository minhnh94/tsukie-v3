...
function ArticleItem(props) {
  const hrefToPost = `en/${ props.tag }/${ props.slug }`
  return (
      ...
      <div className="flex items-start">
        ...
        <div>
          ...
          <div className="flex">
            ...
            <Link className="hidden lg:flex shrink-0 text-sky-500 items-center justify-center w-12 group" href={ hrefToPost } tabIndex={ -1 }>
              <svg
